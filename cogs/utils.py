...
def parse_runs(text: str) -> list[list[tuple[str, str]]]:
    ...
    Each run is a list of (opponent, result) tuples.
...
def validate_runs(runs: list[list[tuple[str, str]]], raw_text: str) -> list[str]:
    """
    Validates the parsed runs. Returns a list of error strings.
    ...
    for i, run in enumerate(runs, 1):
        ...
        # --- Rule 5: each match must be on its own line (no commas) ---
